...
parser.add_argument('--stride_size', dest='stride_size', type=int, default=32, help='# size of the stride') #8 to get enough batches
...
parser.add_argument('--seed', dest='seed', type=int, default=2, help='random seed')
