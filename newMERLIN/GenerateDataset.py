...
class GenerateDataset():
    ...
    def symetrisation_patch_gen(self, ima):
        ...
        return np.concatenate((np.stack((np.real(ima2),np.imag(ima2)),axis=2),opt),axis=2)

    def generate_patches(self,src_dir="./dataset/data/Train",pat_size=256,step=0,stride=64,bat_size=4,data_aug_times=1,n_channels=5):
        count = 0
